...
function sidebar_get_panels_file() {
	try {
		...
		if (!sidebar_file.exists()) {
			...
			var defaultPanels = '<?xml version="1.0"?><RDF:RDF xmlns:RDF="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:NC="http://home.netscape.com/NC-rdf#"><RDF:Description about="urn:sidebar:current-panel-list"><NC:panel-list><RDF:Seq></RDF:Seq></NC:panel-list><NC:version>0.1</NC:version></RDF:Description></RDF:RDF>';
			stream.write(defaultPanels, defaultPanels.length);
			stream.close();
